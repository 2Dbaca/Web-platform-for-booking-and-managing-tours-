    ...
    public function index() {
        ...
        <div class=\"nav\">
            ...
            if(isset($_SESSION["user_id"])) {
                ...
                if(isset($_SESSION["user_role"]) && $_SESSION["user_role"] === "admin") echo "<a href=\"/admin/dashboard\">Админ-панель</a>";
                echo "<a href=\"/logout\">Выйти (" . htmlspecialchars($_SESSION["user_login"]) . ")</a>";
            } else {
                echo "<a href=\"/login\">Вход</a><a href=\"/register\">Регистрация</a>";
            }
        echo "</div>
        <div class=\"hero\"><h2>Откройте для себя лучшие туры</h2><p>Более 100 направлений по всему миру</p>
        ...
        <div class=\"footer\"><p>© 2026 ТурПлатформа | Разработано: Кучеев Е.С., Гончар К.А. (ПИб-242)</p></div>
        </body></html>";
    }
}
?>